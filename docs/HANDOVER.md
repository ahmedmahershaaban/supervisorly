...
**Written:** 2026-07-22, while Ahmed was away. Nothing here has been committed to git.
...
|---|---|
| [atlas.html](atlas.html) / [design-atlas.md](design-atlas.md) | **Start here** — 9 diagrams connecting the whole design. `atlas.html` is the interactive version (published artifact); the `.md` renders on GitHub |
| [product-flow.md](product-flow.md) | The student's journey, in their terms — the authoritative flow |
| [requirements.md](requirements.md) | What Ahmed already built, what broke, and why — 13 ranked pain points |
| [DECISIONS.md](DECISIONS.md) | **56 decisions** with rationale and reversal conditions. **None open** |
| [architecture.md](architecture.md) | The system design |
| [domain-model.md](domain-model.md) | **31 entities** (24 world-model + 7 pipeline/user), each field with an obtainability estimate |
